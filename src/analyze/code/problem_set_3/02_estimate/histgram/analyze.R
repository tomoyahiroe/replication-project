...
main <- function() {
  ...
  hist1 <- plot_modules$plot_histogram(data = simulate_dataset, x = X, bin = 10, title = "bin = 10")
  hist2 <- plot_modules$plot_histogram(data = simulate_dataset, x = X, bin = 0.5, title = "bin = 0.5")
  hist3 <- plot_modules$plot_histogram(data = simulate_dataset, x = X, bin = 0.1, title = "bin = 0.1")
